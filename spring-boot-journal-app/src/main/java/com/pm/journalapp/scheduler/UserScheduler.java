package com.pm.journalapp.scheduler;
...
import com.pm.journalapp.repository.UserRepositoryImpl;
import com.pm.journalapp.service.EmailService;
...
//    @Scheduled(cron = "0 0 9 * * SUN")
    public void fetchUsersAndSendSaMail() {
        ...
        //fetch users who  have sentimentAnalysis on
        List<User> users = userRepository.getUserForSA();
        //fetch their journal entries
        for (User user : users) {
